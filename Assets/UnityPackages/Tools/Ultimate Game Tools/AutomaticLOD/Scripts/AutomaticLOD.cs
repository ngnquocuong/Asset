...
public class AutomaticLOD : MonoBehaviour
{
    ...
    public AutomaticLODEnabler lodEnabler;
    ...
    void Awake()
    {
        ...
        lodEnabler = gameObject.AddComponent<AutomaticLODEnabler>();

        if (AutomaticLODManager.Instance)
            AutomaticLODManager.Instance.RegisterLOD(this);
    ...
    public void ManualUpdate()
    {
        ...
        else
        {
            if (m_originalMesh && b_performCheck && renderCamera)
            {
                ...
                if (nLODLevel != -1 && nLODLevel != m_nCurrentLOD)
                {
                    SwitchToLOD(nLODLevel, false);
                }
            }
        ...
        if (m_nCurrentLOD == GetLODLevelCount() - 1)
        {
            enabled = false;
        }
    }
  ...
  void OnWillRenderObject()
  {
    ...
    public void DeleteLODDataRecursive(GameObject root, GameObject gameObject, bool bRecurseIntoChildren)
    {
